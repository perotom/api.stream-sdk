...
@javax.annotation.Generated(
    ...
    comments = "Source: apis/event/v2/api.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class EventServiceGrpc {

  private EventServiceGrpc() {}

  public static final String SERVICE_NAME = "apis.event.v2.EventService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<stream.api.event.EventsStreamRequest,
      stream.api.event.EventsStreamResponse> getStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Stream",
      requestType = stream.api.event.EventsStreamRequest.class,
      responseType = stream.api.event.EventsStreamResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<stream.api.event.EventsStreamRequest,
      stream.api.event.EventsStreamResponse> getStreamMethod() {
    io.grpc.MethodDescriptor<stream.api.event.EventsStreamRequest, stream.api.event.EventsStreamResponse> getStreamMethod;
    if ((getStreamMethod = EventServiceGrpc.getStreamMethod) == null) {
      synchronized (EventServiceGrpc.class) {
        if ((getStreamMethod = EventServiceGrpc.getStreamMethod) == null) {
          EventServiceGrpc.getStreamMethod = getStreamMethod =
              io.grpc.MethodDescriptor.<stream.api.event.EventsStreamRequest, stream.api.event.EventsStreamResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Stream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stream.api.event.EventsStreamRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stream.api.event.EventsStreamResponse.getDefaultInstance()))
              .setSchemaDescriptor(new EventServiceMethodDescriptorSupplier("Stream"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<stream.api.event.PublishEventRequest,
      stream.api.event.PublishEventResponse> getPublishMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Publish",
      requestType = stream.api.event.PublishEventRequest.class,
      responseType = stream.api.event.PublishEventResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<stream.api.event.PublishEventRequest,
      stream.api.event.PublishEventResponse> getPublishMethod() {
    io.grpc.MethodDescriptor<stream.api.event.PublishEventRequest, stream.api.event.PublishEventResponse> getPublishMethod;
    if ((getPublishMethod = EventServiceGrpc.getPublishMethod) == null) {
      synchronized (EventServiceGrpc.class) {
        if ((getPublishMethod = EventServiceGrpc.getPublishMethod) == null) {
          EventServiceGrpc.getPublishMethod = getPublishMethod =
              io.grpc.MethodDescriptor.<stream.api.event.PublishEventRequest, stream.api.event.PublishEventResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Publish"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stream.api.event.PublishEventRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  stream.api.event.PublishEventResponse.getDefaultInstance()))
  ...
  public static abstract class EventServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<stream.api.event.EventsStreamRequest> stream(
        io.grpc.stub.StreamObserver<stream.api.event.EventsStreamResponse> responseObserver) {
     ...
     * </pre>
     */
    public void publish(stream.api.event.PublishEventRequest request,
        io.grpc.stub.StreamObserver<stream.api.event.PublishEventResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                stream.api.event.EventsStreamRequest,
                stream.api.event.EventsStreamResponse>(
                  this, METHODID_STREAM)))
          .addMethod(
            getPublishMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                stream.api.event.PublishEventRequest,
                stream.api.event.PublishEventResponse>(
  ...
  public static final class EventServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EventServiceBlockingStub> {
     ...
     * </pre>
     */
    public stream.api.event.PublishEventResponse publish(stream.api.event.PublishEventRequest request) {
  ...
  public static final class EventServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EventServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<stream.api.event.PublishEventResponse> publish(
        stream.api.event.PublishEventRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PUBLISH:
          serviceImpl.publish((stream.api.event.PublishEventRequest) request,
              (io.grpc.stub.StreamObserver<stream.api.event.PublishEventResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EventServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return stream.api.event.Api.getDescriptor();
    }
